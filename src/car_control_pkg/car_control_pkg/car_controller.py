...
class CarController:
    ...
    def __init__(self, ros_communicator, nav_processing, data_processor):
    ...
    def car_control(self):
        print("helo")
        # mode, key = (
        #     self.data_processor.get_car_control_signal()[0],
        #     self.data_processor.get_car_control_signal()[1],
        # )
